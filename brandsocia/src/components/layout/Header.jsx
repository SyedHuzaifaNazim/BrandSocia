...
import LoginModal from "@/components/ui/Modal"; // ✅ Import your modal
  ...
  return (
    <div className="relative">
      <header className={headerClasses}>
        ...
        >
          ...
          <div className="md:hidden">
            <button onClick={() => setIsMobileMenuOpen(!isMobileMenuOpen)}>
              <svg 
                className={`h-6 w-6 transition-all duration-300 ${logoColor}`} 
                fill="none" 
                viewBox="0 0 24 24" 
                stroke="currentColor"
              >
        ...
        {/* Mobile Menu */}
        <div
          className={`md:hidden fixed top-16 left-0 w-full bg-white text-black 
        ...
        >
          <div className="flex flex-col p-4 space-y-4">
            ...
            <button 
              onClick={() => setIsLoginOpen(true)} // ✅ open modal from mobile
              className="w-full px-4 py-2 font-medium rounded-full border border-gray-300 hover:bg-gray-100"
            >
              Login
            </button>
