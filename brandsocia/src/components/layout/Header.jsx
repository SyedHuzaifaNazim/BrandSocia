...
export function Navbar() {
  ...
  const [isMobileMenuOpen, setIsMobileMenuOpen] = useState(false); // starts closed
  ...
  useEffect(() => {
    console.log(isMobileMenuOpen , "ASDASD")
  } , [isMobileMenuOpen])
  return (
            ...
            <div className="flex flex-col p-4 space-y-4">
              {NAV_LINKS.map((item) => (
                <Link
                  ...
                  onClick={() => setIsMobileMenuOpen(false)} // close only on link click
                >
                  {item.label}
                </Link>
              ))}
              ...
              <Link
                href="/contact"
                onClick={() => setIsMobileMenuOpen(false)} // close on book a call
